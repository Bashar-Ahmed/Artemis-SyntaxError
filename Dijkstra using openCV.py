...
img = cv2.imread('Screenshot (15).png') # read the image
cv2.circle(img,(385,385), 3, (255,0,0), -1) # add a circle at (5, 220)
cv2.circle(img, (5,5), 3, (0,0,255), -1) # add a circle at (5,5)
...
img = cv2.imread('Screenshot (15).png') # read image
cv2.imwrite('Screenshot (15).png', img)
p = find_shortest_path(img, (5,5), (385,385))
drawPath(img,p)
cv2.imwrite('maze-solution2.png', img)
plt.figure(figsize=(7,7))
